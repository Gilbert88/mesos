    ...
    const http::URL& defaultRegistryUrl)
{
  ...
  // NOTE: Assuming not using the ip address for domain containing
  // 'docker.io'.
  ...
  // Check if necessary to add 'library/' prefix for the case that
  // the registry is docker default 'https://registry-1.docker.io',
