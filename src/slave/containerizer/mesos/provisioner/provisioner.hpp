...
// Provision info struct includes root filesystems for the container
// with specified image and all runtime configurations that are passed
// to Mesos Containerizer.
