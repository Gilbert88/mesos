...
{
public:
  static Try<process::Owned<PendingFutureTracker>> create()
  {
    return process::Owned<PendingFutureTracker>(
        new PendingFutureTracker(process::Owned<PendingFutureTrackerProcess>(
